...
@property (nonatomic, readonly) double totalAmountExcludingUpFrontFees;
...
@property (nonatomic, readonly) NSInteger annualPercentageRate;
/// totalUpFrontFees: total up front fees.
@property (nonatomic, readonly) double totalUpFrontFees;
...
///
/// \param totalAmountExcludingUpFrontFees total amount excludes up front fees..
///
/// \param frequency It can be Monthly.
///
/// \param annualPercentageRate annual percentage rate.
///
...
- (nonnull instancetype)initWithPlanId:(NSString * _Nonnull)planId name:(NSString * _Nonnull)name numberOfInstallments:(NSInteger)numberOfInstallments currency:(NSString * _Nonnull)currency terms:(NSArray<OPPInstallmentTerm *> * _Nonnull)terms totalAmountExcludingUpFrontFees:(double)totalAmountExcludingUpFrontFees frequency:(NSString * _Nonnull)frequency annualPercentageRate:(NSInteger)annualPercentageRate totalUpFrontFees:(double)totalUpFrontFees OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
///
/// \param amount indicate the payment amount
///
/// \param currency eg: USD or EUR
///
...
- (nullable instancetype)initWithCheckoutID:(NSString * _Nonnull)checkoutID paymentBrand:(NSString * _Nullable)paymentBrand amount:(double)amount currency:(NSString * _Nonnull)currency cardNumber:(NSString * _Nonnull)cardNumber expiryMonth:(NSString * _Nonnull)expiryMonth expiryYear:(NSString * _Nonnull)expiryYear holder:(NSString * _Nonnull)holder error:(NSError * _Nullable * _Nullable)error OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCheckoutID:(NSString * _Nonnull)checkoutID paymentBrand:(NSString * _Nullable)paymentBrand error:(NSError * _Nullable * _Nullable)error SWIFT_UNAVAILABLE;
@end
...
- (nonnull instancetype)initWithInstallmentPlans:(NSArray<OPPInstallmentPlan *> * _Nonnull)installmentPlans OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
- (nonnull instancetype)initWithUrl:(NSString * _Nonnull)url content:(NSString * _Nonnull)content languageCode:(NSString * _Nonnull)languageCode OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
